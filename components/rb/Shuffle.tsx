...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  switch (Tag) {
    case 'h1':
      return <h1 ref={setElementRef} className={classes} style={commonStyle}>{text}</h1>;
    case 'h2':
      return <h2 ref={setElementRef} className={classes} style={commonStyle}>{text}</h2>;
    case 'h3':
      return <h3 ref={setElementRef} className={classes} style={commonStyle}>{text}</h3>;
    case 'h4':
      return <h4 ref={setElementRef} className={classes} style={commonStyle}>{text}</h4>;
    case 'h5':
      return <h5 ref={setElementRef} className={classes} style={commonStyle}>{text}</h5>;
    case 'h6':
      return <h6 ref={setElementRef} className={classes} style={commonStyle}>{text}</h6>;
    case 'span':
      return <span ref={setElementRef} className={classes} style={commonStyle}>{text}</span>;
    default:
